...
export const setMediaToFavoritesAction = async (
...
export const setMediaToWatchListAction = async (
  media: MovieInterface | TvShowInterface,
...
export const getMediaDetails: any =
  (mediaId: string, mediaType: MediaEnum, sessionId?: string) => async (dispatch: any) => {
    try {
      dispatch({
        type: 'TOGGLE_LOADING',
        payload: {
...
export const getMediaSeasonDetails: any =
  (mediaId: number, seasonNumber: number, sessionId?: string) => async (dispatch: any) => {
    dispatch({
      type: 'TOGGLE_LOADING',
      payload: {
        field: 'seasons',
...
export const getMediasWatchlist =
  (mediaType: MediaEnum, accountId: number, sessionId: string, page = 1) =>
  async (dispatch: any) => {
